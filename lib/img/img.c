...
bool validateImagem(char *nomeImagem)
{
	...
	if(tamanho > MAX_NOME)
	{
		fprintf(stderr, "Nome de imagem inválido! Deve conter, no máximo, %d caracteres. \n", MAX_NOME);
		return false;
	}
...
/*
* Esconde a mensagem na imagem PPM escolhida
* Recebe o arquivo que conterá o texto, a imagem, o arquivo de saída e dois structs com as informações PPM
...
void readingBMP(int argc, char **argv)
{
	// Variáveis usadas
